...
{
    _game_state = Game::Text("assets/menu/fonts/r-type.ttf");
    _game_state.SetText(game_state);
    _game_state.setFontColor(sf::Color::White);
    _game_state.setFontSize(17);

    _game_name = Game::Text("assets/menu/fonts/r-type.ttf");
    ...
    _game_nbr_players = Game::Text("assets/menu/fonts/r-type.ttf");
